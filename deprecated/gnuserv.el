...
(defconst gnuserv-rcs-header-id "$Header: /tools/general/emacs/smallworld_lisp/site-lisp/RCS/gnuserv.el,v 1.1 2004/02/21 21:40:47 andrewma Exp $")
  ...
  (if (buffer-name buffer)
	...
	(let ((old-clients server-clients))
	  ...
	  (if (buffer-name buffer)	;succeeded in killing?
	    ...
	    t))))) ;bug fix by Andrew. Now returns t when succeeded instead of nil!
